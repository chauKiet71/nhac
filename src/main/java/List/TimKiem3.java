...
public class TimKiem3 extends javax.swing.JPanel {
    ...
    public TimKiem3() {
     ...
     public void init(){
        listChill1.addItem(new Model_Chill(new ImageIcon(getClass().getResource("/icon/search/t9.jpg")), "Sự kiện trực tiếp"));
        listChill2.addItem(new Model_Chill(new ImageIcon(getClass().getResource("/icon/search/t10.jpeg")), "Pride"));
        listChill3.addItem(new Model_Chill(new ImageIcon(getClass().getResource("/icon/search/t11.jpg")), "Pop"));
        listChill4.addItem(new Model_Chill(new ImageIcon(getClass().getResource("/icon/search/t12.jpeg")), "Sức khỏe"));
